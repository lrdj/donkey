...
I've just noticed the access logs filling up with calls to "permalinker"--this is a pretty major oops as I've always believed <span class="caps">URI</span>s should be permanent.

Unfortunately, while I could probably cobble a perl script to handle permalink requests, the unique id was an <span class="caps">MGI</span>-specific thing and got lost in my hasty translation:-( 
