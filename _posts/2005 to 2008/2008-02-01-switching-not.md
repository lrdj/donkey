...
Now, I know that's no big deal in modern laptop terms but for me (as I create my own unique value in partnership with apple's products) it's both great and exactly what need. Unfortunately, everything is beginning to run on Intel macs, Adobe <span class="caps">CS3 </span>looks like Leopard only so if I upgrade I'm also gonna need a new system... add to that the running Windows without <span class="caps">VPC </span>and I really need to update my Powerbook.
...
I need a new laptop with an optical drive, an ethernet, an intel processor and a 12" form-factor. I need it soon, so if I can't get a 12" Powerbook, what are my options? I may actually have to <strong>shudder</strong> switch to a PC and go with a Dell or a Toshiba...
