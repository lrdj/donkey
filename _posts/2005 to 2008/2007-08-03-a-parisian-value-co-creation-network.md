...
For starters, the table is the value co-creation network. The network interacts with its environment (the sun on the <em>térasse</em>, the neibouring tables and chairs) and the customer interacts with it to create value. 
