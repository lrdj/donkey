...
So my accountant tells me I need to make sure and complete my <span class="caps">VAT </span>registration. Don't worry he says, you're an internet consultant so you'll have no trouble...
...
So I call the helpline and am assured that even though the whole site (apart from the <span class="caps">VAT </span>bit) is working and it's just that I need to use internet explorer. But, I say, I haven't got <span class="caps">IE, </span>how can I pay my tax? At which point I was told to go away and stop being an annoying taxpayer...

<span class="mt-enclosure mt-enclosure-image" style="display: inline;"><a href="http://www.donkeyontheedge.com/assets_c/2008/08/vat_site_broken.html" onclick="window.open('http://www.donkeyontheedge.com/assets_c/2008/08/vat_site_broken.html','popup','width=734,height=849,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0'); return false"><img src="/images/vat_site_broken.png" width="520" height="601" alt="VAT site missing its stylesheet" class="mt-image-center" style="text-align: center; display: block; margin: 0 auto 20px;" /></a></span>
