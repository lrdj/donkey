...
image: images/vision-workshops/model-canvas.jpg
alt: "Here's one I prepared earlier (download a PDF of the vision canvas)"
target: /images/vision-workshops/A0-canvas-blackandwhite.pdf
tags:
 - Strategy
 - Vision
 - "Business Design"
...
![Vision = problems + influences + purpose](/images/vision-workshops/4-parts-of-vision.jpg)
...
![The do this get this plan](/images/vision-workshops/How-we-got-here-crop.jpg)
...
![The Vision Canvas](/images/vision-workshops/canvas.png)
...
To try and help with this, I created a workshop canvas for teams to build out their vision. It's called the vision canvas and [you can grab the PDF](/images/vision-workshops/A0-canvas-blackandwhite.pdf) and use it or hack it with your team).

You build the canvas content up over a series of short workshops (YMMV of course based on your team's problem space etc.)

## 1. Problems

![Problem causality, the Ishikaya or fishbone diagram shows which problems are symptoms and which ones are causes](/images/vision-workshops/prob-sheet.jpg)
...
![Purpose workshop output](/images/vision-workshops/purpose.jpg)
...
The intersection of the two circles is your organisation's "elevator pitch". Write this down and stick it to the canvas. _(The purpose butterfly tool isn't mine. I learned it from [Melissa Andrada](https://twitter.com/melissaandrada) at [Wolff Olins](https://www.wolffolins.com/) Kitchen)_


## 3. External factors 

![Pest workshop output](/images/vision-workshops/pest.jpg)
...
![Here's one I completed earlier](/images/vision-workshops/model-canvas.jpg)
