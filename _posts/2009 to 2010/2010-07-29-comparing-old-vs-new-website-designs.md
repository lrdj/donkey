...
can measure this.
Before pulling down your old site and replacing it with the new, run an experiment
pitting the two versions against each other. To do so:
