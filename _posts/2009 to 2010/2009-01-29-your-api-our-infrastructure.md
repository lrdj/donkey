...
From the <a href="http://www.mashery.com/solution/">mashery</a> site:

<blockquote>An <span class="caps">API </span>can unlock new distribution channels for your content and services. But creating an <span class="caps">API </span>is only the first step. Achieving long-term success requires management tools, security controls, built-in scalability, and community support.</blockquote>
