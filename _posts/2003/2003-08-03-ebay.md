...
<li> The search engine is more than a bit ropey (ok, that's a bit unfair as the system is under huge constraints so compromises have probably been made). You remember my kitchen sink collapsed and I had to instal new everything--as a result, I had a set of brass taps sitting around. I listed them as "Victorian brass kitchen mixer tap set" figuring the system would match "kitchen taps" "brass taps" and so on... Unfortunately, for Ebay's search, a person looking for "brass taps" doesn't want to see a "brass tap" which is a bit crap really...</li>
